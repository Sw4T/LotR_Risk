...
public class LOTR_Data {
	...
	/**
	 * Retourne <u>l'objet Region</u> associ� au nom d�fini par <b>nomRegion</b>, retourne <u>null</u> sinon.
	 * @param str
	 */
	...
	/**
	 * G�n�re une ArrayList comprenant <b>nbTerritoire</b> en fonction du type de territoire <b>type</b>.
	 * @param type
	 * @param nbTerritoire
	 */
